...
async def postrules(ctx):
      if ctx.message.author.id != 680519129219727380:
            return
      embed = discord.Embed(title="«────── « ⋅ʚ♡ Rules ♡ɞ⋅ » ──────»", description="**1** \:verify: Always follow the [Discord ToS](https://discordapp.com/terms) and the [Community Guidelines](https://discordapp.com/guidelines). \n\n**2** \:verify: Being toxic __is__ allowed, but don't go over board. Do not start drama with any of the members.\n\n**3** \:verify: Don't advertise in the server nor in DMs. If anyone is DM advertising, report it to staff.\n\n**4** \:verify: No leaking of personal information. No IP grabbers or any kind of doxing, DDoSing, etc.  \n\n**5** \:verify: Respect everyone in the server. \n\n**6** \:verify: No racism, homophobia or any kind of discrimination.\n\n\n\:purplehearts: Use your common sense while chatting in the server, we want it to enjoyable for everyone. So, do not mass ping, spam or anything alike that. \n\n\:purplehearts: If you have found any mistakes/loopholes in the rules, or in the general server. Please DM <@569641643641143306> or <@680519129219727380>.", color=0xF255E3, timestamp=datetime.utcnow())

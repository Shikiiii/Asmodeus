...
async def donate(ctx):
        embed1 = discord.Embed(title="__Nitro Boosting__", description="Want to help the server out? Check the list below and see if you meet these requirements:\n\n``1`` <a:hyperpin:653058051263430676> You got boosts that you aren't using?\n``2`` <a:hyperpin:653058051263430676> Do you like this server?\nWell then, feel free to boost our server! \n\n<a:hyperheart:653058051263430676> **Boosters get a lot of perks, if you'd like to see them all, use ``!tag boosting``.** <a:hyperheart:>", color=0xF216F2)

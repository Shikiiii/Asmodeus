...
async def on_message(message: Message):
    ...
    if message.guild.id == 618048944840245248 and message.channel.id == 618106462090297375:
        chan = discord.utils.get(message.guild.channels, name="ღl-lounge")
    ...
    if(message.content == "!welcome" and (message.author.id == 393839495859929089 or message.author.id == 495680416422821888)):
        ...
        embed1 = discord.Embed(title="**༚ ✧˳⁺ Verification ⁺˳✧ ༚**", description="✧ - Post selfie in <#618061324785680385> with either \"Glow\" or \"Shiki\" on it. \r\n\r\n ✧ - Verified role gives you access to <#618061359711518770> or <#618061387725406232> depends on your gender. \r\n\r\n If you're feeling uncomfortable with posting your selfie, you can DM the selfie to one of the owners.", color=0xFF93F0)
        embed2 = discord.Embed(color=0xFF93F0)
        await message.channel.send(embed=embed1)
        ...
        try:
            ...
            try:
                await message.author.send("Direct link: https://discord.gg/GJ5UDth", embed=embed)
            except:
...
async def survey(ctx):
    ...
    def check(m):
        return m.author.id == usr.id and isinstance(message.channel, DMChannel)
